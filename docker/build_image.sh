...
DOCKER_BUILDKIT=1 docker build --file Dockerfile --no-cache --build-arg BASE_IMAGE=$BASE_IMAGE --build-arg NVIDIA_DRIVER_VERSION="$NVIDIA_DRIVER_VERSION" -t $DOCKER_TAG .
